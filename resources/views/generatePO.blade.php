...
@section('section')
    <section class="container">
        ...
        {{Form::open(['method'=>'post','action'=>'POController@store'])}}
        ...
        <fieldset class="form-group border p-3">
            ...
            <div class="form-row">
                ...
                {{-- <div class="form-group col-md-6">
                    ...
                    <input type="text" required id="supplier" name="supplier" class="form-control form-control-lg" aria-describedby="supplierHelp">
                ...
                <div class="form-group col-md-6">
                    ...
                    <textarea type="text" required id="address" class="form-control" name="address" aria-describedby="addressHelp"></textarea>
        ...
        <fieldset class="form-group border p-3">
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-12">
                    ...
                    <label for="department">Notes (ie Payment Plan if Any / Bank Details if Any)</label>
                    <textarea id="totalTracker" name="reqNotes" class="form-control form-control-lg"></textarea>
        ...
        <fieldset class="form-group border p-3">
            ...
            <div id="items">
                ...
                <div class='form-row'>
                    ...
                    <input type='number' value="{{$pR->productQuantity}}" id='quantity{{$count}}' name='quantity{{$count}}'  class='form-control form-control-lg' aria-describedby='quantityHelp'>
                    ...
                    <input type='text' value="{{$pR -> productName}}" name='pName{{$count}}' readonly class='form-control form-control-lg' aria-describedby='pName_Help'>
                    <small id='unit_price_Help' class='form-text-muted'>product Name</small>
                    </div>

                    <div class='form-group col-md-5'>
                    <label for='description'>Description</label>
                    <textarea type='text' id='description' value="sdsd" name='description{{$count}}' class='form-control form-control-lg' rows='2' aria-describedby='descriptionHelp' readonly>{{$pR -> productDescription}}</textarea>
        ...
        <button type="submit" class="btn btn-lg align-bottom btn-success form-control">submit</button>
        <br/> <br/><br/><br/><br/>
        </form>
    </section>
    <script>
